...
from data_modules.SentEvalDataModule import SentEvalDataModule
from evaluation.senteval_constants import TASK_CLASSES
...
def main(args):
    ...
    # Make data module
    dm = SentEvalDataModule(transformer_model, **dict_args)
    ...
    probe_classifier = probe_model(
        ...
        n_output=TASK_CLASSES[args.data_subset],
        aggregation=aggr,
    ...
    model = LitProbe(
        ...
        probe_classifier,
        args,
        num_classes=TASK_CLASSES[args.data_subset],
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--experiment_name",
        default="senteval_experiment",
        type=str,
        help="Experiment name",
    )
    parser.add_argument(
        "--project_name",
        default="senteval_experiments",
        type=str,
    ...
    # Data
    parser.add_argument("--data", type=str, default="senteval", help="Dataset")
    parser.add_argument(
        "--data_subset",
        type=str,
        default="tree_depth",
    ...
    # )
    parser.add_argument(
        "--max_epochs", default=10, type=int, help="Max number of epochs for training"
    )
    ...
    parser.add_argument(
        ...
        default="aggr-based",
        type=str,
        choices=["attn-based", "aggr-based"],
        help="Probe model to use"
    )
    parser.add_argument(
